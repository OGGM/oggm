...
**both representations are programmatically equivalent** for the
climate preparation, climate calibration, inversion and
ice dynamics tasks. They are both stored as a list of
