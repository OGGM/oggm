...
global runs. The first examples can be run on a laptop within a few minutes.
The mass balance calibration example requires more resources but with
a reasonably powerful personal computer this should be OK.
