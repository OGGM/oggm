...
global runs. The first example can be run on a laptop within a few minutes.
The second example (mass balance calibration) requires more resources but with
a reasonably powerful personal computer you should be OK.
