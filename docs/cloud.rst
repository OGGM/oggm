...
Which means that the OGGM-Edu notebooks are copied into the `oggm-edu-notebooks` folder
...
- `Add OGGM-Edu's tutorial notebooks to your hub <https://hub.oggm.org/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FOGGM%2Foggm-edu-notebooks&urlpath=lab%2Ftree%2Foggm-edu-notebooks%2Foggm-tuto%2Fwelcome.ipynb&branch=master>`_
