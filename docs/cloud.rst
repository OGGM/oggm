...
`hub.oggm.org`_, you will need to have a user account there. It is super easy,
...
resources attributed to them. Currently (we are still trying things out),
...
Which means that the OGGM-Edu notebooks are copied into the `edu_notebooks` folder
...
Frequent use-case: copy-pasting text in JupyterLab
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
