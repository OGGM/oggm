...
The simplest and quickest solution is :ref:`oggm-binder` (no registration necessary).
:ref:`oggm-hub` is much better for more serious work and requires to send us
an email. If you are unsure, have a look at :ref:`hub-binder`!
...
Thanks to the fantastic `MyBinder <https://mybinder.org>`_ service, our OGGM-Binder
test space is available to anyone, with no registration necessary.
Using it is very simple. Just click on the link below to get you started!
...
.. important::
    ...
    **If you want to use OGGM for more serious and permanent work**, we recommend to
    use :ref:`oggm-hub` or :doc:`install OGGM on your computer <installing-oggm>`.
...
of OGGM on our servers in Bremen. It works similarly to MyBinder
