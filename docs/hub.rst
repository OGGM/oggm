...
of OGGM on our servers in Bremen. It works similarly to MyBinder (see :ref:`cloud`)
...
new glacier, OGGM will first check if the data is available there first,
...
environments with a pinned OGGM version, from which you will be able to choose
when logging in.

Accessing the tutorials (and other content) with nbgitpuller
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Per default, your user space after logging in should be empty. We recommend to
...
You can execute this command in the terminal (`Launcher -> Start a terminal`)::
...
terminal to pull content from other repositories as well (e.g. the
...
Say, for example, that you would like to download the content of Lizz'
...
- `Add Lizz' Clubes de Ciencia Perú 2019 notebooks to your hub <https://hub.oggm.org/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2Fehultee%2FCdeC-glaciologia&urlpath=lab%2Ftree%2FCdeC-glaciologia%2F>`_
