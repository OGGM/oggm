...
.. note::
    ...
    *fatal: remote error: 
    ...
    to remote upstream (see `GitHub security`_ for more information`) with one of the two following suggestions::
    
    git remote set-url upstream git@github.com:OGGM/oggm.git
    git remote set-url upstream https://github.com:OGGM/oggm.git    
