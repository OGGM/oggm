...
class TestMassBalanceModels:
    ...
    def test_sfc_type_mb_model(self, hef_gdir):
        ...
        inv_fl = gdir.read_store('inversion_flowlines')[-1]
        h = inv_fl.surface_h
    ...
    def test_sfc_type_save_load(self, hef_gdir):
        ...
        gdir = hef_gdir
        init_present_time_glacier(gdir)
        h = gdir.read_store('inversion_flowlines')[-1].surface_h
        ...
        custom_fl = gdir.read_store('inversion_flowlines')[-1]
    ...
    def test_sfc_type_mb_model_calib_dynamics(self):
        ...
        mb_mod_new.get_specific_mb(
            fls=gdir.read_store('inversion_flowlines'), year=2019)
    ...
    def test_sfc_type_mass_conservation(self, hef_gdir):
        ...
        fl = copy.deepcopy(gdir.read_store('model_flowlines')[-1])
        fl.thick = fl.thick * 0.
        fls = [fl]
