...
from oggm.tests.conftest import test_dir
...
class TestMassBalanceCalibration:
    ...
    def test_mb_calibration_to_rmsd(self, tmpdir):
        
        oggm_test_dir = tmpdir.mkdir("tmp_prepro_climate")
        cfg.initialize()
        cfg.PATHS['working_dir'] = oggm_test_dir
        self.setUp()
        ...
        gdir = oggm.GlacierDirectory(entity, base_dir=oggm_test_dir)
        gis.define_glacier_region(gdir)
        gis.simple_glacier_masks(gdir)
        centerlines.elevation_band_flowline(gdir)
        centerlines.fixed_dx_elevation_band_flowline(gdir)
