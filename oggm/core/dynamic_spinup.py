...
def dynamic_melt_f_run_with_dynamic_spinup(
    ...
    # fls_init is constant across iterations, so only check once and cache result
    if do_inversion and not local_variables.get('_fls_init_matches_gdir', False):
    ...
    current_melt_f_in_gdir = local_variables.get('_last_melt_f_in_gdir',
                                                  gdir.read_json('mb_calib')['melt_f'])
